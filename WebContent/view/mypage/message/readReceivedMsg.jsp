...
<div class="panel panel-default" style="margin: 5px;border: none; box-shadow: none;">
  ...
  <button onclick="popup(${msg.m_no });">답장</button>
...
<script>
function popup(m_no){
	window.open("/mypage/message/send?m_no="+m_no+"&type=reply", "window팝업", "width=400, height=350, menubar=no, status=no, toolbar=no");
};
</script>
