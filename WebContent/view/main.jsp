	...
	<div class="container" id="my_Study">
		<ul style="list-style:none; overflow: hidden">
			...
			<li style="float:left; width:33.333%; margin-bottom:40px">
				...
				<p><a href="/study/detail?study_no=<c:out value="${mystudy.study_no}" />" id=study_name style="color:#4888ca; font-size:15px"><c:out value="${studyList.study_name}"/></a></p>
...
<div class="container" id="deadline_study">
	<ul style="list-style:none; overflow: hidden">
		...
		<li style="float:left; width:33.333%; margin-bottom:40px">
			<p><img src="/cos/upload/<c:out value="${hurrystudy.file_storedname}" /></a>"></p>
