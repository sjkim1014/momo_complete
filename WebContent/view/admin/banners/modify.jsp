...
<form action="/banners/write" method="post"
 class="form-horizontal">
	<div class="form-group">
		...
		>배너명</label>
		<div class="col-sm-5">
		<input type="text" id="title" name="title" value="${bannerView.bn_title }"
			class="form-control"/>
		</div>
	</div>
  ...
  <div class="col-sm-offset-4">
	<button type="button" id="btnSub" class="btn btn-sm" style="color:#ffffff; background:#F67280">수정</button>
