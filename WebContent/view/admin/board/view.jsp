...
<tr>
<td class="info">아이디</td><td>${boardview.u_no }</td>
<td class="info">닉네임</td><td colspan="2">[추후 추가]</td>
</tr>


<tr>
<td class="info">제목</td><td colspan="2">${boardview.b_title }</td>

</tr>

<tr>
<td class="info">작성일</td><td colspan="4">${boardview.b_date }</td>
</tr>
<tr><td class="info">본문</td><td colspan="3">${boardview.b_content }</td></tr>
</table>
</div>
