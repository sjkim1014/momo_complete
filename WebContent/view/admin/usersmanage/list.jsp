...
<td><a  onclick="window.open('/usersmanage/view?u_no=${userslist.u_no }','window_name','width=430,height=500,location=no,status=no,scrollbars=yes');">조회</a></td>
<td id="delete"><a href="/usersmanage/delete?u_no=${userslist.u_no }">삭제</a></td>
